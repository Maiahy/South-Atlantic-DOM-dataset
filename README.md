...
> **A metabolomics dataset of plankton exometabolomes and dissolved organic matter in the South Atlantic Ocean**
...
A total of **269 solid-phase extracted DOM samples** collected at **107 sampling sites** were analyzed using liquid chromatography coupled to high-resolution mass spectrometry (LC–HRMS).
...
2. Merging the full-scan and DDA datasets using **MetabCombiner**.
